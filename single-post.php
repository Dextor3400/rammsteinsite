            ...
            <div class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
                ...
                <div id="navNavbarDropdown" class="navbar-collapse collapse text-center text-lg-start pb-0">
                    <ul class="navbar-nav ml-auto align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active hvrcenter hvr-grow" href="news.php">
                                NEWS
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link hvrcenter hvr-grow" href="music.php">
                                MUSIC
                            </a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container my-5">
            <div>
                ...
                <div class="">
                    ...
                    <div class="nav-item text-center mt-4">
                        <a class="nav-link display-4" href="">TITLE OF THE POST</a>
                    </div>
                    <div class="mt-5">Is et labore adipisci tenetur cum ipsam omnis dolorem! Porro ducimus ipsam maxime
                        eos et nostrum quia, consequatur rem nisi, officia sint nemo cupiditate veritatis asperiores
                        debitis eveniet eaque quibusdam doloribus quas dolore laudantium tenetur dolorem. Nobis est
                        voluptas, ipsum commodi itaque amet dolorem quis perspiciatis eaque maxime, blanditiis suscipit,
                        eum magni nostrum eveniet! Temporibus tenetur laborum quidem doloribus adipisci soluta, quaerat
                        rerum esse consectetur. Quasi eos sit ipsa atque iure illo maxime corrupti nemo, accusamus
                        voluptatum dolorum, possimus debitis et nisi quisquam veniam quod! Repellat fugiat autem ab
                        maxime earum adipisci, reiciendis quos quasi quod doloribus ex!
                    </div>
                    <img class="img-fluid mt-5" src="/images/news_photo.jpg" alt="">
                </div>
                <div style="height: 100px;"></div>
            </div>
        </div>
        <div class="container">
            <a class="float-left" href="">< Previous Post </a>
            <a class="float-right" href="">Next Post ></a>
        </div>
