            ...
            <div class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
                ...
                <div id="navNavbarDropdown" class="navbar-collapse collapse text-center text-lg-start pb-0">
                    <ul class="navbar-nav ml-auto align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active hvrcenter hvr-grow" href="videos.php">
                                VIDEOS
                            </a>
                        </li>
        ...
        <div class="container">
            <div>
                ...
                <div class="embed-responsive embed-responsive-21by9">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/U5HAEzEk8QM"
                        frameborder="0"
            ...
            <div class="mt-5">
                <div class="d-flex justify-content-center align-items-center">
                    <a class="btn btn-primary mr-3" href="">ALL</a>
                    <a class="btn hvr-fade mr-3" href="">MUSIC VIDEOS</a>
                    <a class="btn hvr-fade" href="">LIVE</a>
                </div>
            </div>
            <div class="container mt-5">
                <div class="row mt-5">
                    <div class="col-12 col-md-4">
                        ...
                        <a class="btn btn-outline-secondary btn-lg btn-block mt-1" style="color: white;" href="">DU HAST</a>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="embed-responsive embed-responsive-21by9">
                            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/U5HAEzEk8QM"
                ...
                <div class="row mt-5">
                    <div class="col-12 col-md-4">
                        ...
                        <a class="btn btn-outline-secondary btn-lg btn-block mt-1" style="color: white;" href="">DU
                            HAST</a>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="embed-responsive embed-responsive-21by9">
